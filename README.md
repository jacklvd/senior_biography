...
### Webmaster, ACM, University of Cincinnati, Cincinnati, Ohio  
*Oct 2022 - Dec 2022*  
- Evaluated the source code integrity of the ACM club website, built with Ruby, ensuring its reliability and security.  
- Achieved a 30% increase in newsletter sign-ups in just 3 months, concurrently boosting website traffic by 50%.  
- Addressed more than 500 technical issues for club members and provided support to fellow technicians in enhancing the website's functionality.  
